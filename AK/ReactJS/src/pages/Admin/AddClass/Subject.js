...
class Class_ extends React.Component {
    constructor(props) {
        super(props);
        this.state = { classes: [], subject: [], isOpen: false, selectClassId: '' }
        ...
        this.subjectNameRef = React.createRef();
    ...
    saveClass(e) {
        e.preventDefault();
        let data = {
            subject_name: this.subjectNameRef.current.value,
            class_id: this.state.selectClassId,
            status: this.statusRef.current.value
        }
        this.props.saveSubject_for_admin(data).then(res => {
            this.setState({
                subject: res,
                isOpen: false
            })
            ...
            <React.Fragment>
                <Grid container spacing={3}>
                    <Grid item xs={12}>
                       ...
                       {this.state.selectClassId && <Button variant="contained" color="secondary" onClick={this.AddPopup}>
                            Add new Subject
                </Button>}
                    </Grid>
                    <Grid item xs={12}>
                        {this.state.subject.length && this.listClass()}
